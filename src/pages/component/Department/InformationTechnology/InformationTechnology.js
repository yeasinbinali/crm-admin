...
const InformationTechnology = () => {
  ...
  useEffect(() => {
    fetch("https://crm-server-ouus.onrender.com/informationTechnology")
      .then((res) => res.json())
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://crm-server-ouus.onrender.com/informationTechnology", {
      ...
      body: JSON.stringify(informationTechnology),
    })
      .then((res) => res.json())
      .then((data) => {
        if (data.acknowledged) {
          toast.success("New IT person added");
          reset();
